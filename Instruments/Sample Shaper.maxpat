...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 345.0, 34.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 15.0, 89.0, 20.0 ],
					"text" : "receive #0start"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 870.0, 375.0, 76.0, 20.0 ],
					"text" : "send #0stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 375.0, 77.0, 20.0 ],
					"text" : "send #0start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 780.0, 240.0, 42.0, 20.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 780.0, 330.0, 67.0, 20.0 ],
					"text" : "select s e l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 780.0, 270.0, 135.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 570.0, 121.0, 20.0 ],
					"text" : "receive #0envelopes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 360.0, 108.0, 20.0 ],
					"text" : "send #0envelopes"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 120.0, 117.0, 20.0 ],
...
,
									"patching_rect" : [ 15.0, 90.0, 111.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 15.0, 60.0, 153.0, 20.0 ],
									"text" : "route setduration setspeed"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 158.5, 148.0, 24.5, 148.0 ],
									"source" : [ "obj-11", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 330.0, 73.0, 20.0 ],
					"text" : "route signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 870.0, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 143.0, 387.0, 174.5, 387.0 ],
					"source" : [ "obj-9", 1 ]
				}
